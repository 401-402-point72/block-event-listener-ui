...
<template>
  ...
  >
    ...
    <div class="block pb-4">
      ...
      >
        <h1
          class="text-[rgb(210,210,210)] font-light whitespace-nowrap text-[0.85rem]"
        ...
        <h1
          class="text-[rgb(210,210,210)] font-light whitespace-nowrap text-[0.85rem] last:w-full last:text-right"
          style="text-transform: uppercase"
        >
          TIME
        </h1>
